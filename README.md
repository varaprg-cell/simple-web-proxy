...
Modified September 18, 2026: added the Simple Proxy interface, Google search shortcuts, restricted destination access, and Render deployment configuration.
...
This deployment permits Google, YouTube, their supporting domains, and example.com. Links to unrelated websites are not supported by this version. Only ports 80 and 443 are permitted; private, loopback, and direct IP destinations are disabled. Each connection permits up to 64 streams total.
